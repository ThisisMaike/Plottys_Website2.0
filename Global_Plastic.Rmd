...
mydata2 %>%
  ...
  labs(x = "Plastikmüllproduktion pro Kopf (täglich in g)", y = "Inadäquat entsorgter Plastikmüll pro Kopf (täglich in g)", title = "Das Plastikproblem ist eine Mischung aus hoher Produktion in\n wohlhabenderen und inadäquater Entsorgung in ärmeren Ländern ", subtitle = "Zusammenhang von Wohlstand, Plastikmüllproduktion und inadäquater Entsorgung") +
  annotate(geom = "text", label= "Deutschland", x= 490, y= 20) -> plot_per_capita_waste_mismanagement_GDP
