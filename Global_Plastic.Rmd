...
ggplot(aes(x = Year, y = gpp )) + geom_line(color = '#00868B', alpha = 0.6) + geom_point_interactive(aes(data_id = gpp, tooltip = gpp), color = '#00868B') +
  ...
  labs(x = "", y = "Plastik in Millionen Tonnen", title = "Globale Entwicklung der Plastikproduktion von 1950 bis 2015") +
...
mydata2 %>%
  ...
  labs(x = "Plastikmüll pro Kopf (täglich in kg)", y = "Inadäquat entsorgter Plastikmüll pro Kopf (täglich in kg)", title = "Zusammenhang von Wohlstand, Plastikmüllproduktion \nund inadäquater Entsorgung") -> plot_per_capita_waste_mismanagement_GDP
