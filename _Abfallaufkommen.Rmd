...
Plastikabfall_DE %>%
  mutate(MillTonnen = n/1000000) -> PlastikinMillTonnen
...
ggplot(PlastikinMillTonnen, aes(x= Jahre, y= MillTonnen)) +
  geom_point_interactive (aes (tooltip = MillTonnen), size=5, color="#00868B", alpha = 0.6) +
   geom_segment( aes(x= Jahre, xend=Jahre, y= 0, yend= MillTonnen)) +
   scale_x_continuous(breaks = c(2004,2006,2008,2010,2012,2014,2016,2018))+
  scale_y_continuous(limits = c(0, 3.5)) +
  labs(title = "Aufkommen von Plastikabfall in Deutschland", subtitle = "Plastikabfall von 2004 bis 2018 in Millionentonnen", y= "Mt") + theme_minimal() -> Plot2
